...
import org.wso2.carbon.tenant.deletion.mgt.internal.TenantDeletionManagerComponentDataHolder;

import static org.wso2.carbon.tenant.deletion.mgt.constant.TenantDeletionConstants.*;
...
public class JdbcUtils {
    ...
    public static JdbcTemplate getNewTemplate() {
        ...
        return new JdbcTemplate(TenantDeletionManagerComponentDataHolder.getInstance().getDataSource());
    }
